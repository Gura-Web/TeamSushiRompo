...
(function ($) {
  $.fn.charaMypage = function () {
    ...
    let charaIcon = $(".box-chara__info figure img");
    ...
    if (getStorage("dataPartner") == 0) {
      ...
      if (!getStorage("dataNoFirst")) {
        ...
        charaIcon.attr("src","img/chara01-face01.svg");
        charaStatus.text("普通");
        ...
        charaIcon.attr("src", "img/chara01-face03.svg");
        charaStatus.text("悪い");
        ...
        if (getStorage("dataPoint") >= 0 && 40 >= getStorage("dataPoint")) {
          ...
          charaIcon.attr("src", "img/chara01-face02.svg");
          charaStatus.text("良い")
      ...
      if (!getStorage("dataNoFirst")) {
        ...
        charaIcon.attr("src", "img/chara02-face01.svg");
        charaStatus.text("普通");
        charaMessage.html(userName + "さん！はじめまして！<br>生活チェックは18:00から可能です！")
      }
      else if (getStorage("dataHomeCheck2") == true) {
        charaImage.attr("src", "img/chara02-body03.svg"); // 体調悪い画像
        charaIcon.attr("src", "img/chara02-face03.svg");
        charaStatus.text("悪い");
        ...
        if (getStorage("dataPoint") >= 0 && 40 >= getStorage("dataPoint")) {
          ...
          charaIcon.attr("src", "img/chara02-face02.svg");
          charaStatus.text("良い")
      ...
      if (!getStorage("dataNoFirst")) {
        ...
        if (getStorage("dataPoint") >= 0 && 40 >= getStorage("dataPoint")) {
          ...
          charaIcon.attr("src", "img/chara03-face02.svg");
          charaStatus.text("良い")
